CREATE TABLE simpleassets_assets (
    ...
    collection_name character varying(12) NULL,
...
CREATE TABLE simpleassets_transfers (
    ...
    created_at_block bigint NOT NULL,
    created_at_time bigint NOT NULL,
    CONSTRAINT simpleassets_transfers_pkey PRIMARY KEY (transfer_id)
);
...
ADD CONSTRAINT simpleassets_transfers_assets_assets_fkey FOREIGN KEY (asset_id, contract) REFERENCES simpleassets_assets(asset_id, contract) MATCH SIMPLE ON UPDATE RESTRICT ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED NOT VALID;
ALTER TABLE ONLY simpleassets_transfers_assets
ADD CONSTRAINT simpleassets_transfers_assets_transfers_fkey FOREIGN KEY (transfer_id) REFERENCES simpleassets_transfers(transfer_id) MATCH SIMPLE ON UPDATE RESTRICT ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED NOT VALID;
-- INDEXES --
